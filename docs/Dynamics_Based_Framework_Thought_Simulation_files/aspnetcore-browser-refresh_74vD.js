setTimeout(async function () {
  ...
  const webSocketUrls = 'ws://localhost:50913/Awesome.AI.Web/,wss://localhost:44308/Awesome.AI.Web/'.split(',');
  const sharedSecret = await getSecret('');
  let connection;
